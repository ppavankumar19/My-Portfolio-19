...
const experiences = [
  ...
  },
  {
    ...
    isCurrent: false,
    description:
      'Completed a 6-month intensive training programme under Rohini Kumar Barla spanning the full software stack. Every problem began with writing algorithms and flowcharts before touching code, and solutions were traced step-by-step to build execution-level intuition. Core engineering principles enforced throughout: end-user experience, meaningful variable names, correctness, multiple solutions per problem, no duplicate code, and clean tracing. Studied system internals — C programming, compilation pipeline, LLDB debugging, call stacks, and memory layout (stack, heap, data, code segments). Explored Python internals including bytecode execution and PDB step-debugging. Built frontends with HTML, CSS, and JavaScript including live DOM manipulation, and backend services with Flask and FastAPI. Worked with databases across SQLite3, MySQL, and PL/SQL. Gained hands-on experience with Linux shell scripting, SSH tunnelling and port forwarding, virtual machines (Ubuntu), cloud machine setup, and application deployment. Also covered networking and HTTP fundamentals, cryptography basics, and GenAI-assisted learning workflows.',
